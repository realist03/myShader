...
#include "UnityCG.cginc"
	...
	float4 frag(vertexOutput input) : COLOR
	{
		...
		float3 _ComLightColor0 = (1 - _LightColor0.r, 1 - _LightColor0.g, 1 - _LightColor0.b);
		// default: unlit 
		float3 fragmentColor = _UnlitColor.rgb * _ComLightColor0;
		...
		if (_UnlitOutlineThickness != 0 && dot(viewDirection, normalDirection)
